export const showModelComponentPhysicTsx = `
import {
  Physics,
  useBox,
  useCylinder,
...
function PhysicPlane({ plane }: any) {
  const [ref] = usePlane(() => ({
...
function PhysicShape({ shape }: any) {
  const [ref] = useBox(() => ({
...
function PhysicSphere({ sphere }: any) {
  const [ref] = useSphere(() => ({
...
function PhysicCylinder({ cylinder }: any) {
