...
3. Move the ShowModel.jsx or ShowModel.tsx file into the src folder

4. import the ShowModel component to the place you want the model. 

5. npm start, and you will see the model on your webpage!
`;
